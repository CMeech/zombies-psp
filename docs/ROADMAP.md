...
- The repository purpose and constraints are understandable from `README.md`, `AGENTS.md`, and `docs/PROJECT_HANDOFF.md`.
...
- Record the integration decision and rationale in `docs/decisions/`.
...
- Add significant architectural decisions to `docs/decisions/` rather than burying them here.
...
- Update `docs/PROJECT_HANDOFF.md` whenever the current milestone or immediate next action changes materially.
